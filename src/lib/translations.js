export const translations = {
  fr: {
    ...
    societeDashboard: {
      ...
      immeubleManagement: 'Gestion de votre immeuble —'
    },
    residentDashboard: {
      hello: 'Bonjour,',
      apt: 'Apt'
    ...
    charges: {
      status: {
        ...
        paid: 'Payé',
        late: 'En retard',
        pendingVerification: 'En vérification',
        rejected: 'Rejeté'
      },
      ...
      tableStatus: 'Statut',
      uploadProof: "J'ai payé - envoyer justificatif",
      uploading: 'Envoi...',
  ...
  ar: {
    ...
    societeDashboard: {
      ...
      immeubleManagement: 'إدارة العمارة الخاصة بك —'
    },
    residentDashboard: {
      hello: 'مرحبًا،',
      apt: 'شقة'
    ...
    charges: {
      ...
      tableStatus: 'الحالة',
      uploadProof: 'دفعت - إرسال الإثبات',
