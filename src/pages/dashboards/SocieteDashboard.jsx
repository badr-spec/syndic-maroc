...
// La société externe a les mêmes outils de gestion que le syndic,
// pour gérer la résidence en son nom.
  ...
  return (
    <div>
      <div className="page-head">
        ...
        <p className="muted">Gestion déléguée — {profile.full_name}</p>
      </div>
